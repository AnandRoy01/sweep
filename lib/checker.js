...
class ComprehensiveCleanupChecker {
  ...
  showUsage() {
    ...
    console.log("  unused-sweep");
    console.log("  unused-sweep .");
    console.log("  unused-sweep <path>");
    console.log(
      `  unused-sweep <app-name>         # resolves to ${path.join(this.config.appsDir || "apps", "<app-name>")}`,
    );
    console.log("  unused-sweep all");
    console.log("  npx unused-sweep");
    console.log("");
    ...
    console.log(`  - unused-sweep.config.js`);
    console.log(`  - package.json "unused-sweep" field`);
    console.log("");
